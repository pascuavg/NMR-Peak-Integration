# This code takes processed Bruker data and produces Excel sheets for absolute concentrations and binning areas
# Progress equivalent to nmr_v8 but removed automated peak detection
# auto_v1 started with this code as foundation
